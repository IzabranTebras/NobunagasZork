...
void World::Init()
{
	...
	ptrChar = pb3;
	NPC *guard = new NPC("guard", 3, 1, false, *ptrChar);
	ptrChar = pb5;
	NPC *guard2 = new NPC("guard", 3, 1, true, *ptrChar);
	ptrChar = p12;
	NPC *samurai = new NPC("samurai", 5, 3, true, *ptrChar);
	ptrChar = p21;
	NPC *samurai2 = new NPC("samurai", 5, 3, true, *ptrChar);
	ptrChar = p22;
	NPC *nobunaga = new NPC("nobunaga", 5, 5, false, *ptrChar);
